...
Dashboard for different gression models applied to a 90-10% train-test split on matches that took place after 2000.
...
data_set <- combined_DF %>% filter(year > 2000) %>%
